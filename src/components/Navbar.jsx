...
const Navbar = () => {
    return (<div className="container-fluid nav_bg " id="sticky_nav">
                <div className="row">
                    ...
                    <NavLink className="navbar-brand fw-bold " to="/">Navbar</NavLink>
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <li className="nav-item">
                            <NavLink exact activeClassName="active_link"  className="nav-link "  to="/">Home</NavLink>
                                ...
                                <li className="nav-item">
                            <NavLink  activeClassName="active_link" className="nav-link "  to="/about">About</NavLink>
                                </li>
                                <li className="nav-item">
                            <NavLink  activeClassName="active_link" className="nav-link "  to="/service">Serivce</NavLink>
                                </li>
                                <li className="nav-item">
